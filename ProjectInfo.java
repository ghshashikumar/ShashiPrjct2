...
public class ProjectInfo {
	...
	public void project() {
       ...
       driver.findElement(By.xpath("Projectinfo")).click();
       driver.findElement(By.xpath("Project")).click();
       driver.findElement(By.xpath("Customername")).sendKeys(properties.getProperty("ACME Ltd"));
       driver.findElement(By.xpath("Project")).sendKeys(properties.getProperty("ACME Ltd"));
       driver.findElement(By.xpath("Projectadmin")).sendKeys(properties.getProperty("Linda Anderson"));
