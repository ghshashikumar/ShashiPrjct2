...
public class edit {
	...
	public void edit1() {
        ...
        driver.findElement(By.xpath("project ")).sendKeys(properties.getProperty("Internal - Recruitment"));
      driver.findElement(By.xpath("activity"));
     driver.findElement(By.xpath("date")).sendKeys(properties.getProperty("9:00"));
